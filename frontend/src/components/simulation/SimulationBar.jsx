  ...
  return (
    <div className="bg-surface border border-border rounded-card p-3 sm:p-3.5 shadow-subtle flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-3">
      ...
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-card-sm bg-blue-soft border border-blue/30 flex items-center justify-center text-blue flex-shrink-0">
          <Clock className="w-5 h-5" />
        </div>
        <div>
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-bold uppercase tracking-wider text-text-secondary">Live Simulation Clock</span>
            <span className={`text-[9.5px] font-bold px-1.5 py-0.5 rounded ${
              isRunning ? 'bg-teal-soft text-teal-dark border border-teal/30' : 'bg-surface-muted text-text-muted border border-border'
            }`}>
              {status}
            </span>
          </div>
        ...
        <div className="flex items-center gap-1.5 w-full sm:w-auto">
          ...
          {isRunning ? (
            ...
            <button
              ...
              className="flex-1 sm:flex-initial min-h-[44px] sm:min-h-[34px] px-3.5 bg-navy text-white hover:bg-navy-dark active:bg-navy-dark rounded-card-sm text-xs font-semibold flex items-center justify-center gap-1.5 transition-colors shadow-subtle focus:outline-none focus:ring-2 focus:ring-navy/30"
            >
          ...
          <button
            ...
            className="flex-none min-h-[44px] min-w-[44px] sm:min-h-[34px] sm:min-w-[34px] px-2 bg-surface border border-border text-text-secondary hover:text-text-primary hover:bg-surface-muted active:bg-surface-muted rounded-card-sm text-xs font-medium flex items-center justify-center transition-colors focus:outline-none focus:ring-2 focus:ring-orange/30"
          >
